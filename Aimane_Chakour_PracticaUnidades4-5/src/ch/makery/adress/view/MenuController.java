 ...
 // Pantalla principal en la que se añade o quita contenido
     ...
     void AbrirInstrucciones(ActionEvent event) {
  	    try {
	        ...
	        loader.setLocation(Main.class.getResource("view/Instrucciones.fxml"));
     ...
     void dialogoInicio(ActionEvent event) {
 	    try {
	        // Cargamos el diseño del diálogo desde un XML
	        FXMLLoader loader = new FXMLLoader();
	        loader.setLocation(Main.class.getResource("view/DialogoInicio.fxml"));
	        AnchorPane page = (AnchorPane) loader.load();
	...
	public void abrirFormulario() {    	
     	try {
 			...
 			FXMLLoader loader = new FXMLLoader();
 			loader.setLocation(MenuController.class.getResource("Formulario.fxml"));
